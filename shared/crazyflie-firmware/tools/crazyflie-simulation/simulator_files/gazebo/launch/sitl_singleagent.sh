...
function spawn_model() {
    ...
    gz service -s /world/${gz_world}/create --reqtype gz.msgs.EntityFactory --reptype gz.msgs.Boolean --timeout 300 --req 'sdf_filename: "/tmp/'${MODEL}_${N}'.sdf", pose: {position: {x:'${X}', y:'${Y}', z: 0.5}}, name: "'${MODEL}_${N}'", allow_renaming: 1'
...
if [ "${world}" = "coro" ]; then
	world_file="/CrazySim/pfc_ws/worlds/coro.world"
	gz_world="porcelain_room"
else
